...
PROXY_HTTP_PORT_VALUE="${PROXY_HTTP_PORT}"
PROXY_HTTPS_PORT_VALUE="${PROXY_HTTPS_PORT}"
PROXY_HTTP_PORT="${PROXY_HTTP_PORT_VALUE}" \
PROXY_HTTPS_PORT="${PROXY_HTTPS_PORT_VALUE}" \
